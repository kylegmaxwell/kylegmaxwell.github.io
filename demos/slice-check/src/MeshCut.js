...
export class MeshCut {
     ...
     */
    static trimMeshToPlane(geometry) {
        ...
        cutGeometry.setAttribute('position', new THREE.BufferAttribute(vertices, 3));
     ...
     */
    static findCrossingPoint(offset, pos, i, width, height) {
